...
const DeliveryPersonSignIn = () => {
        ...
        if(email.length === 0)
            ...
            axios.post(url,body).then((response) => {
                ...
                if(result.status === "SUCCESS") {
                    toast.success("Welcome to online food delivery")
    ...
    return (
        <div>
            <h2 className="title" style={{ color: 'rgb(228, 53, 44)'}}>Delivery Person</h2>
            <h3 className="title" style={{ color: 'rgb(228, 53, 44)'}}> sign in</h3>
            <div className="row">
